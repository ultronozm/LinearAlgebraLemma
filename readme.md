...
class="math inline">\(n\)</span> ones. Suppose that <span
class="math display">\[[x,[z,\tau]] = [y, \tau]\]</span> for some <span
class="math inline">\(y \in M_n\)</span>. Then <span
class="math inline">\(x\)</span> is a scalar matrix.</em></p>
</div>
<p>Here is the corresponding statement in Lean:</p>
...
example (n : ℕ)
  ...
  : ∃ (r : ℂ), x = r • (1 : Mat ℂ (n+1)) := by sorry</code></pre>
<p>This result is perhaps of little intrinsic interest – it is the
“linear algebra lemma” required at the end of a longer analytic argument
– but I was nevertheless motivated to formalize it as an educational
project. In this note, we record a proof and indicate which parts
correspond to which Lean files and theorems (it would presumably be
better to use <a
href="https://github.com/PatrickMassot/leanblueprint">blueprint</a> for
this).</p>
<div class="remark">
...
data-reference="theorem:cnee1jt0hq">3</a>, we have <span
